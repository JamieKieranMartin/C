...
int main(void) {
    ...
    //fill a buffer (array) of charactes with the string "Microcontroller fun begins! - Happy Coding", in the position x,y
    //array is too big for the screen size
    //draw_string(10,5, "Microcontroller fun begins! - Happy Coding", FG_COLOUR);
    
    ////array is too big for the screen size, so we break it into 3 parts
     draw_string(5,5,"Microcontroller",FG_COLOUR);
     draw_string(5,15,"fun begins!",FG_COLOUR);
     draw_string(5,25,"Happy Coding",FG_COLOUR);
